...
tlc_takeover_linear_regression <- lm(TLC_takeover ~ TLC_failure, data = data_RTs_cens_NA_removed)

# summarizing the linear regression model to see the parameter estimates
summary(tlc_takeover_linear_regression)

# confidence intervals for the linear regression
confint(tlc_takeover_linear_regression)
```
...
linear_regression_emmeans <- emmeans(object = tlc_takeover_linear_regression, specs = ~ TLC_failure, at = list(TLC_failure = seq(1.5, to = 10.5, by = .1))) %>% 
  data.frame()
...
```{r}
# fitting a varying intercept model
tlc_takeover_varying_intercept <- lme4::lmer(TLC_takeover ~ TLC_failure + (1 | ppid), data = data_RTs_cens_NA_removed)

# summarizing the model
summary(tlc_takeover_varying_intercept)

# generating confidence intervals
confint(tlc_takeover_varying_intercept)
