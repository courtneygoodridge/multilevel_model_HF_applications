...
ggsave(here::here("multilevel_model_HF_applications/plots/fig_3.tiff"), plot = fig_3, width = 16, height = 8, units = 'cm', dpi = 300, type = 'cairo')
```
...
random_effects <- VarCorr(mod_3) %>%
    as.data.frame()

sigma_beta_f <- random_effects$sdcor[2]

# relative size of the SD versus the fixed effect
sigma_beta_f / fixef(mod_3)[2]

# upper bound
(fixef(mod_3)[2] + 1.96 * sigma_beta_f)
