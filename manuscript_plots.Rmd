...
```{r}
goodridge_2024_dat <- fread(file = here::here("multilevel_model_HF_applications/data/goodridge_2024_dat.csv"))
```
...
fig_5 <- ggplot(mod_4_ranef, mapping = aes(x = Intercepts, y = n_back_effect)) +
  geom_point() +
...
ggsave(here::here("multilevel_model_HF_applications/plots/fig_5.tiff"), plot = fig_5, width = 8, height = 7, units = 'cm', dpi = 300, type = 'cairo')
```
