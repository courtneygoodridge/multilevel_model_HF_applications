...
A maximal model contains a random slope for each fixed effect alongside all possible correlations between random effect parameters. The standard deviation for the effect of lead vehicle is by the lowest of all the parameters. 
...
## LRT for lead vehicle and interaction random effects 
